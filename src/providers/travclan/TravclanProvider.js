...
// Travclan integration is not yet implemented.
// All methods throw a 501 error so the calling code fails clearly
// rather than silently doing nothing.
class TravclanProvider extends FlightProvider {
  _notImplemented(method) {
    const err = new Error(`TravclanProvider.${method}() is not yet implemented.`);
    err.statusCode = 501;
    throw err;
  }
...
module.exports = TravclanProvider;
